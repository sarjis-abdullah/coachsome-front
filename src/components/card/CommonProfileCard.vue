      ...
      <v-card-text class="text-xs-center">
        <div class="profile-card__top">
          ...
          <div class="profile-card__avatar">
            <single-image-lightbox :src="image" :title="name" :badge-key="badgeKey" v-if="role != 'athlete'"/>
            <single-image-lightbox :src="image" :title="name"  v-else/>
          </div>
        ...
        <div class="profile-card__middle mt-5">
          ...
          <div v-if="rating_count && role != 'athlete'">
