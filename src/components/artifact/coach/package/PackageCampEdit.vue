  ...
  <div>
    <v-card elevation="0">
      <v-card-text>
        ...
        <v-row>
          <v-col cols="12" md="2">
            <v-btn color="primary-light-1" depressed dark @click="update()">
              {{ $t("package_btn_label_update") }}
            </v-btn>
          </v-col>
        </v-row>
      </v-card-text>
...
export default {
  ...
  computed: {
    ...
    priceErrors() {
      ...
      !this.$v.form.price.required &&
        errors.push("Price per sesion is required.");
    ...
    completedByDaysErrors() {
      const errors = [];
      if (!this.$v.form.completedByDays.$dirty) return errors;
      !this.$v.form.completedByDays.decimal &&
        errors.push("Only number value is allowed");
      return errors;
    },
    discountErrors() {
  ...
  methods: {
    ...
    resetForm() {
      ...
      this.form.attendeesMin = null;
      this.form.attendeesMax = null;
      this.form.completedByDays = null;
    }
  },
  mounted() {
    ...
    this.form.timePerSession = this.timePerSession;
    this.form.price = this.price;
    this.form.isSpecialPrice = this.isSpecialPrice;
    this.form.attendeesMin = this.attendeesMin;
    this.form.attendeesMax = this.attendeesMax;
