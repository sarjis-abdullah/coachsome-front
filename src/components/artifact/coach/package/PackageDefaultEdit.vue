<template>
  <v-card elevation="0">
    <v-card-text>
      ...
      <v-row>
        ...
        <v-col cols="12" md="8">
          <v-row>
            ...
            <v-col cols="6" md="8" class="mt-3">
              <span class="ml-2 primary-light-1--text">
                <slot name="code" :currency-code="currencyCode">{{
                  currencyCode
                }}</slot>
              </span>
            </v-col>
      ...
      <v-row>
        <v-col cols="12" md="2">
          <v-btn depressed color="primary-light-1" dark @click="update()">{{
...
export default {
  ...
  data() {
    return {
      counter: 1000,
      currencyCode: currencyConfig.default.code,
      form: {
        title: "",
        description: "",
        session: null,
  ...
  mounted() {
    ...
    this.form.transportFee = this.transportFee;
