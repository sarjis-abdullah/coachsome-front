      ...
      <v-row>
        <v-col>
          ...
          <v-row
            ...
            :style="{
              background:
                'url(' + require('@/assets/images/home/hero.jpg') + ')',
          ...
          >
            <v-col cols="12">
              ...
              <v-row justify="center">
                <v-col>
                  <v-row justify="center" v-show="!popular.isLoading">
                    <v-col cols="12" md="6">
                      <div
                        :class="[
              ...
              <v-row>
                <v-col>
                  <v-row justify="center" v-show="!companyRating.isLoading">
                    <v-col cols="12" md="6">
                      <div
                        :class="[
...
export default {
  ...
  head() {
    return {
      title: "Find privat sportstræning online - Hurtigt og nemt",
