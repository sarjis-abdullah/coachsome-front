            ...
            <div class= "onboarding--body--right" :class="{'onboarding--body--right--md' : !$vuetify.breakpoint.smAndDown,'onboarding--body--right--sm mb-15': $vuetify.breakpoint.smAndDown}">
                <v-row>
                    ...
                    <v-col cols="12">
                        ...
                        <v-autocomplete
                            v-else
                            v-model="profileData.category_tag_list_id"
                            :items="categories"
                            item-text="name"
                            return-object
...
<script>
import { coachProfileApi, sportCategoryApi } from "@/api";
...
export default {
    ...
    computed: {
        validContinue(){
            if(this.profileData.category_tag_list_id.length > 0 && this.completed){
                return true;
            }else{
                return false;
            }
    ...
    methods:{
        ...
        removeCategory(item) {
            this.profileData.category_tag_list_id.splice(this.profileData.category_tag_list_id.indexOf(item), 1);
            this.profileData.category_tag_list_id = [...this.profileData.category_tag_list_id];
        },
